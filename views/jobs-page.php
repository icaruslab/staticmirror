...
<div class="wrap">
    ...
    <table class="widefat striped">
        <thead>
            <tr>
                ...
                <td style="text-align:center;">
                    <?php echo $label( 'autoJobQueueCopyUploads' ); ?>
                </td>
                <td style="text-align:center;">
        ...
        <tbody>
            <tr style="text-align:center;">
                ...
                <td><?php echo $input( 'autoJobQueueCopyUploads' ); ?></td>
    ...
    <form
            name="wp2static-process-jobs-now"
            method="POST"
            action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">

        <?php wp_nonce_field( 'wp2static-process-jobs-now' ); ?>
        <input name="action" type="hidden" value="wp2static-process-jobs-now" />

        <button class="button">Process jobs now</button>
    </form>
