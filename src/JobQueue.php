...
class JobQueue {
     ...
     */
    public static function addJob( string $job_type, $job_meta = null ) : void {
        ...
        $query_string = "INSERT INTO $table_name (job_type, status, job_meta) VALUES (%s, 'waiting', %s);";
        $query = $wpdb->prepare( $query_string, [ $job_type, json_encode($job_meta) ] );
