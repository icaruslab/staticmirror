...
class WordPressAdmin {
    ...
    public static function registerHooks( string $bootstrap_file ) : void {
        ...
        add_action(
            'wp_ajax_wp2static_detect',
            [ Controller::class, 'wp2staticDetect' ],
            10,
            0
        );

        add_action(
            'wp_ajax_wp2static_crawl',
            [ Controller::class, 'wp2staticCrawlOnly' ],
            10,
            0
        );

        add_action(
            'wp_ajax_wp2static_post_process',
            [ Controller::class, 'wp2staticPostProcess' ],
            10,
            0
        );

        add_action(
            'wp_ajax_wp2static_copy_uploads',
            [ Controller::class, 'wp2staticCopyUploads' ],
            10,
            0
        );
        ...
        add_action(
            'admin_post_wp2static-process-jobs-now',
            [ Controller::class, 'wp2staticProcessJobsNow' ],
            10,
            0
        );
