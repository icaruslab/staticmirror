...
class CoreOptions {
    ...
    public static function optionSpecs() : array {
        ...
        $specs = [
            ...
            self::makeOptionSpec(
                'string',
                'excludeCustomPostTypes',
                '',
                'Custom Post Types to Exclude',
                'Those Custom Post Types will be excluded from URL Detection.',
                ''
            ),
            self::makeOptionSpec(
                'boolean',
            ...
            self::makeOptionSpec(
                ...
                'detectPagination',
                '0',
                'Detect Category Pagination',
                'Include Pagination URLs in URL Detection.'
            ),
            self::makeOptionSpec(
                'boolean',
                'queueJobOnPostSave',
            ...
            self::makeOptionSpec(
                ...
                'useWpCil',
                '1',
                'Use WP-CLI for job execution',
                'Use WP-CLI to execute jobs. This is useful if with big websites to avoid timeout issues.'
            ),
            self::makeOptionSpec(
                'array',
            ...
            self::makeOptionSpec(
                ...
                '1',
                'Hosts to Rewrite',
                'Hosts to rewrite to the deployment URL. Note(Write a Site Name )',
                'localhost'
            ),
            self::makeOptionSpec(
                'boolean',
...
VALUES (%s, %s, %s);";
    ...
    public static function getValue( string $name ) : string {
        ...
        if ( ! isset($option_value) || ! is_string( $option_value ) ) {
    ...
    public static function savePosted( string $screen = 'core' ) : void {
        ...
        switch ( $screen ) {
            case 'core':
                ...
                $wpdb->update(
                    $table_name,
                    [ 'value' => sanitize_text_field($_POST['excludeCustomPostTypes'])],
                    [ 'name' => 'excludeCustomPostTypes' ]
                );
                ...
                $wpdb->update(
                    $table_name,
                    [ 'value' => isset( $_POST['detectPagination'] ) ? 1 : 0 ],
            ...
            case 'jobs':
                ...
                $wpdb->update(
                    $table_name,
                    [ 'value' => isset( $_POST['autoJobQueueCopyUploads'] ) ? 1 : 0 ],
                    [ 'name' => 'autoJobQueueCopyUploads' ]
                );
            ...
            case 'advanced':
                ...
                $wpdb->update(
                    $table_name,
                    [ 'value' => isset( $_POST['useWpCil'] ) ? 1 : 0 ],
                    [ 'name' => 'useWpCil' ]
                );
